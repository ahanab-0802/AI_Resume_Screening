...
async def analyze_resume(
    ...
    if result.get('jd_comparison'):
        jd_comparison_result = JDComparison(
            ...
            matched_skills=result['jd_comparison'].get('matched_skills', [])[:15],
            missing_skills=result['jd_comparison'].get('missing_skills', [])[:15],
...
async def generate_pdf(
    ...
    try:
        ...
        analysis_data["candidate_name"] = analysis_data.get("candidate_name", "")
